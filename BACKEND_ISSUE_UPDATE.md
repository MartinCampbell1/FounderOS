...
`<local FounderOS checkout>/apps/web/lib/chain-graph-data.ts` was loading:
...
Files:
- `<local FounderOS checkout>/quorum/orchestrator/idea_graph.py`
- `<local FounderOS checkout>/quorum/orchestrator/memory_graph.py`
...
File:
- `<local FounderOS checkout>/quorum/orchestrator/observability/evals.py`
...
Files:
- `<local FounderOS checkout>/quorum/orchestrator/observability/dossier_explainability.py`
