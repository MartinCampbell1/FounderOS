...
- `<local FounderOS checkout>/quorum/orchestrator/api.py` — dossier endpoint handler
- `<local FounderOS checkout>/quorum/orchestrator/discovery_store.py` — SQLite operations
- `<local FounderOS checkout>/quorum/orchestrator/engine.py` — any graph/embedding work
