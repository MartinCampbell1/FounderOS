    ...
    <ShellListLink href={href} className="space-y-2.5">
      ...
      <div className="grid gap-2 md:grid-cols-2">
        <div className="space-y-0.5">
          ...
          <div className="text-[12px] leading-5 text-foreground/82">
            {handoff.default_project_name ?? briefTitle(handoff.brief)}
          </div>
        </div>
        <div className="space-y-0.5">
          <div className="text-[10px] font-medium uppercase tracking-[0.12em] text-muted-foreground">
          ...
          <div className="text-[12px] leading-5 text-foreground/82">
            {handoff.recommended_launch_preset_id ?? "not specified"}
          </div>
        </div>
      </div>
...
export function ExecutionHandoffsWorkspace({
  ...
  return (
    <ShellPage>
        ...
        meta={
          <>
            <span className="text-[12px] leading-5 text-foreground">
              {snapshot.handoffs.length} active brief
              {snapshot.handoffs.length === 1 ? "" : "s"}
            </span>
            <span className="text-[12px] leading-5 text-muted-foreground">
              Store-backed queue with auto-expiring handoffs
            </span>
          </>
        }
        actions={
      ...
      >
        <OperatorNote icon={<Rocket className="h-4 w-4 text-emerald-400" />} title="Launch intent">
        ...
        <OperatorNote icon={<Clock3 className="h-4 w-4 text-amber-400" />} title="Store expiry">
          <p className="text-[12px] leading-6 text-muted-foreground">
