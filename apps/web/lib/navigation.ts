...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        key: "discovery:swipe",
        label: "Swipe Queue",
        href: "/discovery/board/simulations",
        icon: Zap,
      },
      {
  ...
  },
  {
    ...
    children: [
      {
        key: "execution:projects",
        label: "Projects",
        href: "/execution",
        icon: FolderKanban,
      },
      {
        key: "execution:intake",
        label: "Intake",
        href: "/execution/intake",
        icon: MessageSquarePlus,
      },
      {
        key: "execution:controlplane",
        label: "Control Plane",
        href: "/execution/review",
        icon: ShieldCheck,
      },
      {
        key: "execution:handoffs",
        label: "Handoffs",
    ...
    groups: [
      {
        ...
        items: [
          ...
          "Execution review queue for issues, approvals, and tool permissions",
